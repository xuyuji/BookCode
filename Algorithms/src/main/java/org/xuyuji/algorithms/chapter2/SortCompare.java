 ...
 * Selection 1000 100 cmd:classes>java
 * org.xuyuji.algorithms.chapter2.SortCompare Shell Insertion 1000 100
 * 
 * @author xuyuji
 *
 */
public class SortCompare {
	public static double time(String alg, Double[] a) {
		...
		if (alg.equals("E2_1_24"))
			E2_1_24.getInstance().sort(a);
		if (alg.equals("E2_1_25"))
			E2_1_25.getInstance().sort(a);
